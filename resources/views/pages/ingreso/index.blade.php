                            ...
                            <div class="card-body">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="Fecha Ingreso">{{ __('Fecha de ingreso') }} <span
                                                style="color: red">*</span></label>
                                        <input type="date" class="form-control" id="fecha_recepcion"
                                            name="fecha_recepcion" required>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="Fecha Entrega">{{ __('Fecha de entrega') }} <span
                                                style="color: red">*</span></label>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6" style="margin-top: 44px">
                                        <label for="Numero">{{ __('Numero extintores') }} <span
                                                style="color: red">*</span></label>
                                        <input required type="number" class="form-control" id="numero_total_extintor"
                                            name="numero_total_extintor" placeholder="Ej: ###">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="encargado">{{ __('Cliente') }} <span
                                                style="color: red">*</span></label>
                                        <select id="encargado" name="encargado_id" class=" form-control chosen-select">
